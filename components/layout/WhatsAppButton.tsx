  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      <a
        ...
        className="relative flex items-center gap-3 rounded-full bg-[#25D366] px-5 py-3.5 shadow-lg shadow-[#25D366]/40 transition-all duration-300 hover:scale-105 hover:shadow-[#25D366]/60"
      >
        {/* Pulse ring */}
        <span className="absolute inset-0 rounded-full bg-[#25D366] animate-ping opacity-25" />
        <svg viewBox="0 0 24 24" fill="white" className="relative h-6 w-6 shrink-0">
