...
const services = [
  {
    ...
    detail: "24h/24 — 7j/7 — partout à Dubaï — sans frais additionnels",
    icon: (
  ...
  },
  {
    ...
    detail: "Option disponible sans retenir le passeport",
    icon: (
      <svg className="h-12 w-12" fill="none" stroke="currentColor" strokeWidth={0.7} viewBox="0 0 24 24">
  ...
  },
  {
    ...
    detail: "Réservation en 2 minutes via WhatsApp",
    icon: (
      <svg className="h-12 w-12" fill="none" stroke="currentColor" strokeWidth={0.7} viewBox="0 0 24 24">
  ...
  },
  {
    ...
    detail: "Flotte régulièrement contrôlée et entretenue",
    icon: (
      <svg className="h-12 w-12" fill="none" stroke="currentColor" strokeWidth={0.7} viewBox="0 0 24 24">
    ...
    <div className="min-h-screen pt-20">
      ...
      <div className="mx-auto max-w-7xl px-6 py-16">
          ...
          {services.map((s, i) => (
            ...
            >
              <div className="flex-1 border border-[#222222] p-12 text-center">
                ...
                <p className="text-xs tracking-widest text-[#888888] uppercase">Inclus</p>
              </div>
              <div className="flex-1">
                ...
                <p className="mt-4 text-sm text-[#C9A84C]">{s.detail}</p>
              </div>
            </div>
          ))}
        </div>
        ...
        <div className="mt-20 border border-[#222222] p-12 text-center">
          <h2 className="font-display mb-4 text-3xl font-light text-[#F5F5F0]">Réservez en 2 minutes</h2>
          <p className="mb-8 text-[#888888]">Notre équipe est disponible 24h/24 sur WhatsApp pour répondre à toutes vos demandes.</p>
          <a
