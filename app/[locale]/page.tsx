...
import { FEATURED_VEHICLES_QUERY, FEATURED_YACHTS_QUERY, LATEST_BLOG_POSTS_QUERY, SOCIAL_PROOF_QUERY } from "@/sanity/lib/client";
...
export default async function HomePage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const [vehicles, yachts, posts, socialProofData] = await Promise.all([
